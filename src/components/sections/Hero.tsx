        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Discover one-of-a-kind handbags made with premium materials and traditional
              craftsmanship. Each piece tells a story of artistry and attention to detail.
            </p>
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              ...
              <Button size="lg" variant="outline" className="text-base">
                <Play className="mr-2 size-5" /> Crafting Process
              </Button>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-2xl border bg-card shadow-2xl">
              <div className="aspect-[16/10] relative">
                <Image
                  src="https://images.unsplash.com/photo-1553062407-98eeb64c6a62?q=80&w=1920&auto=format&fit=crop"
                  alt="Handcrafted leather handbag collection"
                  fill
            ...
            <div className="absolute -left-6 -bottom-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              <p className="text-xs text-muted-foreground">Artisan Made</p>
              <p className="text-sm">
                <span className="font-semibold">100%</span> handcrafted
              </p>
            </div>
          </div>
        </div>
