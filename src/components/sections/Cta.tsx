...
export default function CTA() {
  const stats = [
    ...
    { value: '100%', label: 'Handcrafted', icon: Shield },
    { value: '50+', label: 'Unique Designs', icon: Zap },
    { value: '5★', label: 'Customer Rating', icon: Sparkles },
  ];
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Each Artisan Bag Co. piece tells a story of meticulous craftsmanship and timeless
                elegance. Find the bag that speaks to your unique style and becomes part of your
                journey.
              </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Lifetime Craftsmanship Guarantee</h3>
              <p className="text-sm text-muted-foreground">We stand behind every stitch and seam</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Custom monogramming and bespoke options
              </p>
            </div>
          </div>
        </div>
